...
### Phase 3 計画立案（notes §4 CI 統合 / §7.3 ベルカ式 / §12 ロードマップから）

- [x] 1. `phase3.0-spec-v0.3.md` — notes §4→spec §9、§7 描画様式→§14 の昇格 + v0.2 宿題（監視エラー挙動）
- [x] 2. `phase3.1-diff-engine.md` — IR 差分エンジン（構造変化 + メトリクス変化、`magia diff`）
- [x] 3. `phase3.2-spell-diff.md` — 視覚的 diff（変化箇所の強調、DSL `highlight:` の解禁）
- [x] 4. `phase3.3-ci-integration.md` — GitHub Actions + PR コメント投稿（Spell Diff）
- [x] 5. `phase3.4-dataflow-ir.md` — データフロー解析（Use-Def chains を IR へ）
- [x] 6. `phase3.5-belka-style.md` — ベルカ式レンダラ（3点力場、RenderStyle::Belka の解禁）
- [x] 7. TODO.md 更新（優先度・依存関係・アーカイブ整理）、ADDF テスト、オーナーへ提示、コミット
