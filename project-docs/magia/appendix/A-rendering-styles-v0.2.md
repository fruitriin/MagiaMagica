# MagiaMagica Appendix A: 描画様式カタログ v0.2

> **本文書の位置づけ**
> 本文書は『MagiaMagica 仕様書 v0.1』および『MagiaMagica Phase 2 以降の議論ノート v0.1』の補遺 A として、描画様式 (RenderStyle) の体系を詳細にカタログ化したものである。本ツールが扱う「式 (Style)」の網羅的な分類と、各式の技術的対応、自動推奨ヒューリスティクスを記述する。
>
