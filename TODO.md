...
**4.2 (近接度本実装) も完了 (判定合格 2026-06-12)**。次は **4.3 (Vue SSR 一本化)**。
...
| 15.5 | 4.3.7 | [docs/plans/phase4.3.7-diff-on-web.md](docs/plans/phase4.3.7-diff-on-web.md) | 未着手（**4.6 から先行切り出し** — serve に ?diff=<rev> で Spell Diff overlay + live diff。前提 (4.3 M4) は完了済。オーナー要望 2026-06-12） |
