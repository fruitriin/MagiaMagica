...
| 18.5 | 4.8 | [docs/plans/phase4.8-method-chain-flow.md](docs/plans/phase4.8-method-chain-flow.md) | 未着手（**メソッドチェーンの鎖化** — 召喚陣から召喚陣へ数珠つなぎ。オーナー観察 2026-06-12。Rust 抽出 + IR Edge + レイアウトの土台込み） |
