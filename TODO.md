...
| 18.5 | 4.8 | [docs/plans/phase4.8-method-chain-flow.md](docs/plans/phase4.8-method-chain-flow.md) | **M1 判定合格 + M2 完了**（2026-06-12。鎖 + コールバック補助陣 (AuxRingKind::Closure、波配置)。M2 判定待ち — 衝突回避は宿題） |
