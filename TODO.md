...
**4.2 (近接度本実装) も完了 (2026-06-12、意匠判定待ち)**。次は **4.3 (Vue SSR 一本化)**。
...
| 13 | 4.2 | [docs/plans/phase4.2-proximity-model.md](docs/plans/phase4.2-proximity-model.md) | **完了**（2026-06-12、意匠判定待ち。呼び出し関係 + 3層リング。call_graph 新設） |
