...
**4.3.7 (diff を web に — live diff) も完了 (2026-06-12)**。次は **4.0.6 後半 / 4.3.5 (結節点)** など意匠系 (全て Vue だけで実施可能) か **4.4 (呼び出しジャンプ)**。
...
| 15.5 | 4.3.7 | [docs/plans/phase4.3.7-diff-on-web.md](docs/plans/phase4.3.7-diff-on-web.md) | **完了**（2026-06-12。?diff=<rev> + live diff (保存→即ハロー)。素材送付済み） |
| 16 | 4.4 | [docs/plans/phase4.4-call-jump.md](docs/plans/phase4.4-call-jump.md) | 未着手（イメージ感のみ） |
| 16.5 | 4.4.5 | [docs/plans/phase4.4.5-entrypoint-on-web.md](docs/plans/phase4.4.5-entrypoint-on-web.md) | 未着手（イメージ感のみ。**4.5 から先行切り出し** — 監視ファイルを Web から切替 + ?file= 同期。オーナー要望 2026-06-12） |
| 17 | 4.5 | [docs/plans/phase4.5-workspace-overview.md](docs/plans/phase4.5-workspace-overview.md) | 未着手（イメージ感のみ） |
