...
| 18.6 | 4.9 | [docs/plans/phase4.9-space-aware-chain-layout.md](docs/plans/phase4.9-space-aware-chain-layout.md) | 未着手（**空きスペース活用レイアウト** — 鎖の伸縮 + 折り曲げ + クロージャ陣の場所探し。オーナー観察 2026-06-13。4.8 の構造はそのまま） |
