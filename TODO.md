...
**4.3.7 (live diff)・4.4.5 (エントリポイント切替) も完了 (2026-06-12)**。**4.4 (呼び出しジャンプ) も完了 (2026-06-12)**。Rust/土台系の残りは **4.5 (俯瞰 — 着手時に精緻化)**。意匠系 (4.0.6 後半 / 4.3.5 / 4.6 / 4.7) は後回し方針 (オーナー指示 2026-06-12)。
