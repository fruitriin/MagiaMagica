...
| 18.5 | 4.8 | [docs/plans/phase4.8-method-chain-flow.md](docs/plans/phase4.8-method-chain-flow.md) | **M1 完了**（2026-06-12。チェーン検出 + EdgeKind::Chain + 数珠つなぎ配置 + 細線。意匠判定待ち — 衝突回避は判定後） |
