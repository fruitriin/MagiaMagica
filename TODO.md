...
| 優先度 | Phase | 計画ファイル | 状態 |
|---|---|---|---|
| 1 | 1.8 | [docs/plans/phase1.8-layout-collision-avoidance.md](docs/plans/phase1.8-layout-collision-avoidance.md) | 未着手 |
| 2 | 2.0 | [docs/plans/phase2.0-spec-v0.2.md](docs/plans/phase2.0-spec-v0.2.md) | 未着手 |
| 3 | 2.1 | [docs/plans/phase2.1-dev-server.md](docs/plans/phase2.1-dev-server.md) | 未着手 |
| 4 | 2.2 | [docs/plans/phase2.2-layer-toggle.md](docs/plans/phase2.2-layer-toggle.md) | 未着手 |
